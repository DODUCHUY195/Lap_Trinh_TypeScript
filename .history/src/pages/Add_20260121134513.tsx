...
const schema = z.object({
  ...
  credit: z
    .number({ invalid_type_error: "Số tín chỉ phải là số" })
    .positive("Số tín chỉ phải > 0"),
  category: z.enum(["Cơ sở", "Chuyên ngành", "Đại cương"], {
    errorMap: () => ({ message: "Loại môn học không hợp lệ" }),
  }),
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <input
            ...
            type="number"
            className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            onChange={(e) => setValue("credit", Number(e.target.value))}
          />
          {errors.credit && (
